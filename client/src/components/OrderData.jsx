      ...
      <div className="w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <p className="flex items-center gap-1 text-textColor">
            ...
            <span className="font-bold text-headingColor">{data?.total}</span>
          </p>
          ...
          {admin && (
            <div className="flex items-center justify-center gap-2">
              ...
              <motion.p
                ...
                className={`text-base text-orange-500 font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Preparing
              </motion.p>
              {/* 2 */}
              <motion.p
                ...
                className={`text-base text-red-500 font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Cancelled
              </motion.p>
              {/* 3 */}
              <motion.p
                ...
                className={`text-base text-emerald-500 font-semibold capitalize border border-gray-300 px-2 py-[2px] rounded-md cursor-pointer`}
              >
                Delivered
              </motion.p>
            </div>
