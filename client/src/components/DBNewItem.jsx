...
import {
  getAllProducts,
  setAllProducts,
} from "../context/actions/productAction";
  ...
  return (
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4">
        {/* <MdFastfood className="text-xl flex align-start justify-center text-gray-700" />
          ...
          {statuses &&
            statuses?.map((data) => (
              <p
                ...
                className={`px-4 py-2 rounded-md text-md text-textColor font-semibold cursor-pointer hover:shadow-md border border-gray-200 backdrop-blur-md
            ${
        ...
        <div className="w-full bg-card backdrop-blur-md h-340 rounded-md border-2 border-dotted border-gray-300 cursor-pointer">
          {isLoading ? (
